...
#include "INSALEMomentumTraction.h"

registerMooseObject("whaleApp", INSALEMomentumTraction);

template <>
InputParameters
validParams<INSALEMomentumTraction>()
{
...
INSALEMomentumTraction::INSALEMomentumTraction(const InputParameters & parameters)
  : INSALEMomentumBase(parameters)
{
}

Real
INSALEMomentumTraction::computeQpResidual()
{
  Real r = computeQpResidualViscousPart();
...
Real
INSALEMomentumTraction::computeQpResidualViscousPart()
{
...
Real
INSALEMomentumTraction::computeQpJacobian()
{
  Real jac = computeQpJacobianViscousPart();
  return jac;
}

Real
INSALEMomentumTraction::computeQpJacobianViscousPart()
{
...
Real
INSALEMomentumTraction::computeQpOffDiagJacobianViscousPart(unsigned jvar)
{
